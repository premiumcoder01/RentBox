...
const RangeSlider = ({
  ...
  return (
    <View style={[styles.sliderContainer, {width: sliderWidth}]}>
      ...
      <Animated.View
        style={[sliderStyle, styles.sliderFront, extraSliderStyle]}
      />
      <PanGestureHandler onGestureEvent={gestureHandler}>
        <Animated.View style={[animatedStyle, styles.thumb, extraThumbstyle]}>
      ...
      <PanGestureHandler onGestureEvent={gestureHandler2}>
        <Animated.View style={[animatedStyle2, styles.thumb, extraThumbstyle]}>
